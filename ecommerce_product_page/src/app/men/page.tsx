...
import OverlayCarousel from "@/components/OveralyCarousel";
    ...
    <>
      <div className="mx-auto grid lg:grid-cols-2 lg:mt-12 gap-10 place-content-center">
        <div className="flex place-content-center">
          ...
          >
            <Carousel className="relative lg:rounded-md" onClick={() => setOverlay(true)}>
              {({ api }: any) => {
                return {
      ...
      {showOverlay &&
        createPortal(
          <Modal close={() => setOverlay(false)}>{<OverlayCarousel />}</Modal>,
          document.body,
          "MODAL"
        )}
    </>
